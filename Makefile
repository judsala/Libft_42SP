...
SRC = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	...
	ft_putstr_fd.c ft_strchr.c ft_strdup.c ft_striteri.c ft_split.c \
...
OBJ =  ft_atoi.o ft_bzero.o ft_calloc.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	...
	ft_memmove.o ft_memset.o ft_putchar_fd.o ft_putnbr_fd.o ft_putendl_fd.o \
	ft_putstr_fd.o ft_strchr.o ft_strdup.o ft_striteri.o ft_split.o \
